...
class Tester
{
	...
	public static void main(String[] args) throws IOException, DocumentException 
	{
		...
		System.out.println(lineBlock1.getStatsAsString());
		...
		Document document1 = new Document("/home/linux/eclipse-workspace/AM1_AM2_AM3_TextProcessor/Resources/SampleDocs/economy_mt.txt",DocumentRawType.RAW);

		System.out.println("\n");
		System.out.println("Total number of paragraphs: "+document1.getLineblocks().size());
		...
		for(String str:document1.calculateStatistics())
		{
		...
		System.out.println("\n");
		System.out.println("Total number of paragraphs: "+document2.getLineblocks().size());
		...
		for(String str:document2.calculateStatistics())
		{
			System.out.println(str);
		}
	    ...
	    List<LineBlock> plineBlocks = document1.getLineblocks();
